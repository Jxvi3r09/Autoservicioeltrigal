...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'contenttypes','contenttype'),(6,'pagina','backup'),(7,'pagina','categoria'),(8,'pagina','configuracionrespaldo'),(13,'pagina','detallepedido'),(12,'pagina','pedido'),(11,'pagina','producto'),(9,'pagina','proveedor'),(10,'pagina','usuario'),(5,'sessions','session');
...
INSERT INTO `django_migrations` VALUES (1,'contenttypes','0001_initial','2025-05-21 21:02:08.339611'),(2,'contenttypes','0002_remove_content_type_name','2025-05-21 21:02:08.455099'),(3,'auth','0001_initial','2025-05-21 21:02:09.030285'),(4,'auth','0002_alter_permission_name_max_length','2025-05-21 21:02:09.136817'),(5,'auth','0003_alter_user_email_max_length','2025-05-21 21:02:09.148174'),(6,'auth','0004_alter_user_username_opts','2025-05-21 21:02:09.159955'),(7,'auth','0005_alter_user_last_login_null','2025-05-21 21:02:09.171987'),(8,'auth','0006_require_contenttypes_0002','2025-05-21 21:02:09.175522'),(9,'auth','0007_alter_validators_add_error_messages','2025-05-21 21:02:09.187725'),(10,'auth','0008_alter_user_username_max_length','2025-05-21 21:02:09.197409'),(11,'auth','0009_alter_user_last_name_max_length','2025-05-21 21:02:09.208667'),(12,'auth','0010_alter_group_name_max_length','2025-05-21 21:02:09.238901'),(13,'auth','0011_update_proxy_permissions','2025-05-21 21:02:09.249659'),(14,'auth','0012_alter_user_first_name_max_length','2025-05-21 21:02:09.260546'),(15,'pagina','0001_initial','2025-05-21 21:02:10.423263'),(16,'admin','0001_initial','2025-05-21 21:02:10.644111'),(17,'admin','0002_logentry_remove_auto_add','2025-05-21 21:02:10.655730'),(18,'admin','0003_logentry_add_action_flag_choices','2025-05-21 21:02:10.673269'),(19,'sessions','0001_initial','2025-05-21 21:02:10.726406');
...
INSERT INTO `django_session` VALUES ('e66kjx92v3d3espx3k5tz7k16snlv3cq','.eJxVjDsOwyAQRO9CHSHAfFOm9xnQLqyDkwhLxq6i3D1YcpFUI715M28WYd9K3Butcc7syiS7_DKE9KR6FPkB9b7wtNRtnZEfCj_bxscl0-t2un8HBVrp60Emb9BZZVBNoHO2VkttO5RBCQgJRIDBYJCoyaPukSZJ6LxzhMKxzxfPSTed:1uHqov:ru0bOb5Wog2CLo5HHCPeOuTg-Qo7X4-o24Dl1rv9Hxk','2025-06-04 21:17:49.610789');
...
CREATE TABLE `pagina_detallepedido` (
  ...
  KEY `pagina_detallepedido_proveedor_id_c41190a6_fk_pagina_pr` (`proveedor_id`),
  CONSTRAINT `pagina_detallepedido_pedido_id_0a521758_fk_pagina_pedido_id` FOREIGN KEY (`pedido_id`) REFERENCES `pagina_pedido` (`id`),
  CONSTRAINT `pagina_detallepedido_producto_id_6811f4eb_fk_pagina_producto_id` FOREIGN KEY (`producto_id`) REFERENCES `pagina_producto` (`id`),
  CONSTRAINT `pagina_detallepedido_proveedor_id_c41190a6_fk_pagina_pr` FOREIGN KEY (`proveedor_id`) REFERENCES `pagina_proveedor` (`id`),
...
INSERT INTO `pagina_pedido` VALUES (1,'2025-05-21 21:17:39.564158','2025-05-22','pendiente',2);
...
INSERT INTO `pagina_producto` VALUES (1,'jabon fab',47836247.00,0.00,0,NULL,'','2025-05-21 21:17:20.625472',1);
...
INSERT INTO `pagina_proveedor` VALUES (2,'312543','ara','fhdjkfd@gmail.com','83749374','sogamoso','2025-05-21 21:16:48.353018',1);
...
INSERT INTO `pagina_usuario` VALUES (1,'pbkdf2_sha256$870000$TScHryKzY78S114ujU8WEo$ewfiD2QB4b/dvwJLnpe0DXt+x++TIv9FFuzOxCBGhdo=','2025-05-21 21:16:07.493565',0,'javier','javier','gomez',0,1,'2025-05-21 21:15:45.833282','CC','23647326','administrador','oscarjaviergomez12@gmail.com','','2025-05-21 21:15:49.768718');
...
-- Dump completed on 2025-05-21 16:17:53
